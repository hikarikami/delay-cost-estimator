        ...
        <div className="mt-4 space-y-2 text-sm text-muted-foreground">
          <div>
            ...
            <p className="mt-1 ml-4 text-xs">
              Longer delays cost more because you lose ongoing value and the one-off benefit is worth less in today's dollars.
            </p>
          </div>
        </div>
      </CardHeader>
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="max-w-xs">
                          Reduction in present value of the one-off benefit due to delay (discount rate: {formatNumber(discountRate, 1)}% annually).
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
